...
return (
<div
className={transition-opacity duration-700 ease-in-out ${   fadeIn ? 'opacity-100' : 'opacity-0'   } bg-gradient-to-br from-green-800 to-green-600 text-white p-5 rounded-2xl shadow-lg space-y-3}
>
