...
const GLFInfo = ({ account, provider }) => {
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-br from-gray-800 via-gray-900 to-black border border-green-600 p-6 shadow-xl text-white space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-center">
        <div className="bg-gray-900 rounded-xl p-5 shadow-inner border border-green-500 hover:scale-105 transition-transform">
        ...
        <div className="bg-gray-900 rounded-xl p-5 shadow-inner border border-yellow-500 hover:scale-105 transition-transform">
